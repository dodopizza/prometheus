...
type Rule interface {
	...
	Eval(ctx context.Context, queryOffset time.Duration, evaluationTime time.Time, queryFunc QueryFunc, externalURL *url.URL, limit int, description string) (promql.Vector, error)
